...
int32 MM_AppInit(void)
{
    ...
    */
    CFE_MSG_Init(CFE_MSG_PTR(MM_AppData.HkPacket), CFE_SB_ValueToMsgId(MM_HK_TLM_MID), sizeof(MM_HkPacket_t));
    /*
...
void MM_HousekeepingCmd(const CFE_SB_Buffer_t *BufPtr)
{
    ...
    */
    if (MM_VerifyCmdLength(&BufPtr->Msg, ExpectedLength))
    {
        ...
        */
        CFE_SB_TimeStampMsg(CFE_MSG_PTR(MM_AppData.HkPacket));
        CFE_SB_TransmitMsg(CFE_MSG_PTR(MM_AppData.HkPacket), true);
